...
NOTE: This is an integration test that requires a live Qdrant instance with data.
"""
            ...
            "sample_results": [
                {
                    ...
                    "values": {
                        field: _extract_nested_value(p.payload, field)
...
async def test_comprehensive_statistics_filters(client: QdrantClient) -> None:
    ...
    test_cases = [
        ...
        (
            ...
            "MAL score >= 7.0",
            ["title", "statistics.mal.score"],
        ),
        (
            {"statistics.mal.score": {"gte": 6.0, "lte": 8.0}},
            "MAL score 6.0-8.0",
            ["title", "statistics.mal.score"],
        ),
        (
            {"statistics.mal.scored_by": {"gte": 10000}},
            "MAL scored_by >= 10K",
            ["title", "statistics.mal.scored_by"],
        ),
        (
            {"statistics.mal.members": {"gte": 50000}},
            "MAL members >= 50K",
            ["title", "statistics.mal.members"],
        ),
        (
            {"statistics.mal.favorites": {"gte": 100}},
            "MAL favorites >= 100",
            ["title", "statistics.mal.favorites"],
        ),
        (
            {"statistics.mal.rank": {"lte": 5000}},
            "MAL rank <= 5000",
            ["title", "statistics.mal.rank"],
        ),
        (
            {"statistics.mal.popularity_rank": {"lte": 10000}},
            "MAL popularity_rank <= 10K",
            ["title", "statistics.mal.popularity_rank"],
        ),
        # AniList Statistics (3 fields)
        (
            {"statistics.anilist.score": {"gte": 7.0}},
            "AniList score >= 7.0",
            ["title", "statistics.anilist.score"],
        ),
        (
            {"statistics.anilist.favorites": {"gte": 10}},
            "AniList favorites >= 10",
            ["title", "statistics.anilist.favorites"],
        ),
        (
            {"statistics.anilist.popularity_rank": {"lte": 5000}},
            "AniList popularity_rank <= 5000",
            ["title", "statistics.anilist.popularity_rank"],
        ),
        # AniDB Statistics (2 fields)
        (
            {"statistics.anidb.score": {"gte": 7.0}},
            "AniDB score >= 7.0",
            ["title", "statistics.anidb.score"],
        ),
        (
            {"statistics.anidb.scored_by": {"gte": 1000}},
            "AniDB scored_by >= 1000",
            ["title", "statistics.anidb.scored_by"],
        ),
        # Anime-Planet Statistics (3 fields)
        (
            {"statistics.animeplanet.score": {"gte": 7.0}},
            "Anime-Planet score >= 7.0",
            ["title", "statistics.animeplanet.score"],
        ),
        (
            {"statistics.animeplanet.scored_by": {"gte": 1000}},
            "Anime-Planet scored_by >= 1000",
            ["title", "statistics.animeplanet.scored_by"],
        ),
        (
            {"statistics.animeplanet.rank": {"lte": 1000}},
            "Anime-Planet rank <= 1000",
            ["title", "statistics.animeplanet.rank"],
        ),
        # Kitsu Statistics (5 fields)
        (
            {"statistics.kitsu.score": {"gte": 7.0}},
            "Kitsu score >= 7.0",
            ["title", "statistics.kitsu.score"],
        ),
        (
            {"statistics.kitsu.members": {"gte": 1000}},
            "Kitsu members >= 1000",
            ["title", "statistics.kitsu.members"],
        ),
        (
            {"statistics.kitsu.favorites": {"gte": 10}},
            "Kitsu favorites >= 10",
            ["title", "statistics.kitsu.favorites"],
        ),
        (
            {"statistics.kitsu.rank": {"lte": 10000}},
            "Kitsu rank <= 10000",
            ["title", "statistics.kitsu.rank"],
        ),
        (
            {"statistics.kitsu.popularity_rank": {"lte": 10000}},
            "Kitsu popularity_rank <= 10000",
            ["title", "statistics.kitsu.popularity_rank"],
        ),
        # AnimeSchedule Statistics (4 fields)
        (
            {"statistics.animeschedule.score": {"gte": 6.0}},
            "AnimeSchedule score >= 6.0",
            ["title", "statistics.animeschedule.score"],
        ),
        (
            {"statistics.animeschedule.scored_by": {"gte": 5}},
            "AnimeSchedule scored_by >= 5",
            ["title", "statistics.animeschedule.scored_by"],
        ),
        (
            {"statistics.animeschedule.members": {"gte": 10}},
            "AnimeSchedule members >= 10",
            ["title", "statistics.animeschedule.members"],
        ),
        (
            {"statistics.animeschedule.rank": {"lte": 10000}},
            "AnimeSchedule rank <= 10000",
            ["title", "statistics.animeschedule.rank"],
        ),
    ...
    for filter_dict, description, expected_fields in test_cases:
        result = await _test_single_filter(
            client, filter_dict, description, expected_fields
        )

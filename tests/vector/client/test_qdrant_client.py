...
@pytest.mark.asyncio
async def test_update_single_vector(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_single_vector_invalid_name(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_mixed(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_image_vector(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_all_text_vectors(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_with_failures(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_all_validation_failures(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_partial_anime_success(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_multiple_anime_mixed_results(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_dimension_validation(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_invalid_data_types(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_same_vector_multiple_updates(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
    ...
    title_vector2 = client.embedding_manager.text_processor.encode_text(title_content)  # Same content, different instance
...
@pytest.mark.asyncio
async def test_update_batch_vectors_large_batch(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
@pytest.mark.asyncio
async def test_update_batch_vectors_preserves_order(client: QdrantClient, seeded_test_data: List[AnimeEntry]):
...
async def test_update_batch_anime_vectors_basic(client: QdrantClient):
    ...
    assert result['total_requested_updates'] == 4, "Should request 2 vectors × 2 anime = 4 updates"
    assert result['successful_updates'] >= 2, "Should have at least some successful updates"
...
async def test_update_batch_anime_vectors_all_vectors(client: QdrantClient):
    ...
    assert result['successful_updates'] + result['failed_updates'] + result['generation_failures'] >= 0
...
async def test_update_batch_anime_vectors_with_progress_callback(client: QdrantClient):
    ...
    assert callback_calls[-1]['current'] == 5, "Last callback should report all 5 anime processed"
    assert callback_calls[-1]['total'] == 5, "Should report correct total"


@pytest.mark.asyncio
async def test_update_batch_anime_vectors_handles_generation_failures(client: QdrantClient):
    ...
    if result['generation_failures'] > 0:
        assert len(result['generation_failures_detail']) > 0, "Should provide failure details"
...
@pytest.mark.asyncio
async def test_update_single_anime_vector_multiple_vectors_sequential(client: QdrantClient):

...
from enrichment.crawlers.anisearch.anisearch_anime_crawler import (
    BASE_ANIME_URL,
...
from enrichment.crawlers.framework import DockerTransport, NullRepository
...
async def test_fetch_main_page_none_returns_none(mocker) -> None:
    ...
    mocker.patch(
        "enrichment.crawlers.anisearch.anisearch_anime_crawler.crawl_single_url",
...
async def test_fetch_anisearch_anime_returns_none_when_no_data(mocker) -> None:
    mocker.patch(
        "enrichment.crawlers.anisearch.anisearch_anime_crawler._fetch_anisearch_anime_data",
        new_callable=AsyncMock,
        return_value=None,
    )

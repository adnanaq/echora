        ...
        with patch(
            ...
            with patch(
                ...
                with patch.object(sys, "argv", test_args):
                    import enrichment.crawlers.anisearch_character_crawler as crawler_module
...
@pytest.mark.asyncio
@patch("enrichment.crawlers.anisearch_character_crawler.fetch_anisearch_characters")
async def test_main_function_success(mock_fetch):
    """Test main() function handles successful execution."""
    from enrichment.crawlers.anisearch_character_crawler import main

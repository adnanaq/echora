...
class TextSearchInputSchema(BaseIOSchema):  # type: ignore[misc]
    ...
    tool_type: Literal["text_search"] = Field(
        default="text_search", description="Tool type discriminator"
    )
...
class ImageSearchInputSchema(BaseIOSchema):  # type: ignore[misc]
    ...
    tool_type: Literal["image_search"] = Field(
        default="image_search", description="Tool type discriminator"
    )
...
class MultimodalSearchInputSchema(BaseIOSchema):  # type: ignore[misc]
    ...
    tool_type: Literal["multimodal_search"] = Field(
        default="multimodal_search", description="Tool type discriminator"
    )
    query: str = Field(..., description="Text query to search for anime content")
...
class CharacterSearchInputSchema(BaseIOSchema):  # type: ignore[misc]
    ...
    tool_type: Literal["character_search"] = Field(
        default="character_search", description="Tool type discriminator"
    )
    query: str = Field(

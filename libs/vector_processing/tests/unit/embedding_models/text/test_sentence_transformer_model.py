...
from vector_processing.embedding_models.text.sentence_transformer_model import SentenceTransformerModel
...
class TestSentenceTransformerModel:
    ...
    def test_multilingual_support(self, mock_sentence_transformer):
        ...
        model1 = SentenceTransformerModel("sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    ...
    def test_import_error(self):
        ...
        with patch.dict("sys.modules", {"sentence_transformers": None}):
            with pytest.raises(ImportError, match="Sentence Transformers dependencies missing"):

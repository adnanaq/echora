...
class TestFetchAnisearchAnimeURLNormalization:
    ...
    async def test_fetch_anisearch_anime_full_url(self):
        ...
        with patch(
            ...
            with patch(
                "enrichment.crawlers.anisearch_anime_crawler.AsyncWebCrawler"
            ) as MockCrawler:
                mock_crawler = AsyncMock()
                mock_crawler.arun = AsyncMock(return_value=[])
    ...
    async def test_fetch_anisearch_anime_invalid_url(self):
        ...
        with patch("enrichment.crawlers.anisearch_anime_crawler.AsyncWebCrawler"):
            mock_redis = AsyncMock()
    ...
    async def test_fetch_anisearch_anime_basic_success(self):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "enrichment.crawlers.anisearch_anime_crawler._fetch_and_process_sub_page"
                ) as mock_sub_page:
...
class TestFetchAnisearchAnimeEdgeCases:
    ...
    def test_extract_path_raises_on_invalid_url(self):
        from enrichment.crawlers.anisearch_anime_crawler import _extract_path_from_url
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch.object(sys, "argv", test_args):
                        ...
                        import enrichment.crawlers.anisearch_anime_crawler as crawler_module
...
@pytest.mark.asyncio
@patch("enrichment.crawlers.anisearch_anime_crawler.fetch_anisearch_anime")
async def test_main_function_success(mock_fetch, tmp_path):
    """Test main() function handles successful execution."""
    from enrichment.crawlers.anisearch_anime_crawler import main
...
async def test_main_function_handles_os_error(mock_fetch):
    ...
    with patch(
        "sys.argv",
        ["script.py", "https://www.anisearch.com/anime/18878", "--output", "/invalid/path.json"],
    ):
        exit_code = await main()

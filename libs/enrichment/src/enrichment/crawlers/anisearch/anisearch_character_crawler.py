...
from enrichment.crawlers.anisearch.anisearch_mapper import character_from_anisearch
...
_TITLE_LANG_RE = re.compile(
    r'<div[^>]+class="title"[^>]+lang="([^"]+)"', re.IGNORECASE
)
    ...
    return {
        ...
        "fields": [
            ...
            },
            {
                ...
                "type": "list",
                "fields": [
                    {"name": "url", "selector": ".", "type": "attribute", "attribute": "src"}
                ],
            },
            {

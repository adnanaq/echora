...
async def main() -> None:
    ...
    result1 = await agent.parse_and_search(query1)
    ...
    result9 = await agent.parse_and_search(query9)
    ...
    result10 = await agent.parse_and_search(query10)
    ...
    result11 = await agent.parse_and_search(query11)
    ...
    result12 = await agent.parse_and_search(query12)
    ...
    result13 = await agent.parse_and_search(query13)
    ...
    result14 = await agent.parse_and_search(query14)
    ...
    result15 = await agent.parse_and_search(query15)
    ...
    result16 = await agent.parse_and_search(query16)
    ...
    result19 = await agent.parse_and_search(query19)
    ...
    result20 = await agent.parse_and_search(query20)
